...
export const updateAsistenciaInscrito = (eventoId, inscripcionId, asistio) =>
  apiClient.put(`/admin/eventos/${eventoId}/inscritos/${inscripcionId}/asistencia`, { asistio }).then((r) => r.data)
